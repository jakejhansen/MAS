...
public class Node {
	...
	public Node(Node parent, int MAX_ROW1, int MAX_COL1) {
		this.parent = parent;
		//MAX_COL1 = 70;
		//MAX_ROW1 = 70;
		this.MAX_COL = MAX_COL1;
		this.MAX_ROW = MAX_ROW1;
		this.walls = new boolean[MAX_ROW1][MAX_COL1];
		this.boxes = new char[MAX_ROW1][MAX_COL1];
		this.goals = new char[MAX_ROW1][MAX_COL1];
		if (parent == null) {
			this.g = 0;
		} else {
			this.g = parent.g() + 1;
